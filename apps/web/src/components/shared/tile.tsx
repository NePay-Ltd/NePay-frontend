...
export function Tile({
    ...
    return (
        <button
            ...
            className={cn(
                "relative flex flex-col items-center justify-center gap-2 rounded-lg border border-border bg-white p-4 text-center shadow-sm transition-all",
                ...
                "disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:border-border disabled:hover:shadow-sm",
                className,
            )}
            {...props}
        >
            <span className="flex h-12 w-12 items-center justify-center rounded-sm bg-violet-100 text-violet-700">
