        ...
        <AnimatePresence>
            {visible && (
                <motion.div
                    ...
                    className="fixed bottom-0 left-0 right-0 z-40 w-full px-4 sm:px-8 bg-white dark:bg-[#121212] border-t border-border py-4 pb-safe sm:py-6 shadow-[0_-8px_30px_rgba(0,0,0,0.04)]"
                >
